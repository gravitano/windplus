...
<template>
  <!-- navbar -->
  <div class="navbar border-b border-gray-800 bg-gray-900">
    ...
    <a href="#" class="navbar-brand w-[260px] dark:text-white">Dashboard</a>

    <div class="input-group input-group-inner">
      <input
        type="search"
        class="form-control pr-10 dark:bg-gray-800 dark:border-gray-800 dark:text-white"
        placeholder="Search"
        aria-label="Search"
    ...
    <div class="dropdown">
      <button
        class="btn btn-text btn-icon dark:text-gray-300"
  ...
  <main class="flex">
    <!-- nav drawer -->
    <div
      class="nav-drawer nav-drawer-dark nav-drawer-screen border-r border-gray-800 shadow flex-shrink-0"
    >
      <!-- list -->
      <div class="list list-hover flex-grow">
        ...
        <!-- list item -->
        <a href="#" class="list-group-item gap-4 dark:text-gray-500">
          ...
          <div class="list-group-item-content">
            <div class="list-group-item-subtitle dark:text-gray-500">
              Dashboard
            </div>
          </div>
        </a>
        ...
        <!-- list item -->
        <a
          class="list-group-item gap-4 dark:text-gray-500"
        ...
        >
          ...
          <div class="list-group-item-content">
            <div class="list-group-item-subtitle dark:text-gray-500">Team</div>
          </div>
    ...
    <div class="px-4 py-2 bg-gray-900">
      <div class="mb-4">
        <h1 class="font-semibold mb-1 text-gray-800 text-xl dark:text-gray-300">
          Dashboard
        </h1>
      ...
      <div class="card card-bordered dark:border-gray-700 dark:bg-gray-800">
        <div class="card-header dark:border-gray-700 dark:text-gray-300">
          What's Changed?
        </div>
        <div class="card-body dark:text-gray-400">
