...
<div class="card card-bordered" id="hover">
  <div class="card-header">
    List Hover
  </div>
  <div class="card-body">
...
<div class="card card-bordered" id="rich-content">
  <div class="card-header">
    Rich Content
  </div>
  <div class="card-body">
...
<div class="card card-bordered" id="menu">
  <div class="card-header">
    List Menu
  </div>
  <div class="card-body">
    <div class="list list-hover">
      <div class="list-header text-sm py-1 uppercase">
        Main Menu
      </div>
      <!-- list item -->
...
<div class="card card-bordered" id="multilevel-menu">
  <div class="card-header">
    List Menu Multilevel
  </div>
  <div class="card-body">
    <div class="list list-hover">
      <div class="list-header text-sm py-1 uppercase">
